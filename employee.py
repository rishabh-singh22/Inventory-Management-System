...
class employeeClass:
    def __init__(self,root):
        ...
        cmb_search.current(0)              #by defalut Select is place
        ...
        self.EmployeeTable["show"] = "headings"   # To disappear space before headings
        ...
        self.EmployeeTable.column("contact",width=130)
        self.EmployeeTable.column("dob",width=140)
        self.EmployeeTable.column("doj",width=150)
        self.EmployeeTable.column("password",width=160)
        self.EmployeeTable.column("utype",width=170)
        self.EmployeeTable.column("address",width=180)
        self.EmployeeTable.column("salary",width=190)
